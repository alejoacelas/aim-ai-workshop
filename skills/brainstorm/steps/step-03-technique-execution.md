...
- Ask "Continue with current technique?" before moving to next technique
...
- Selected techniques from Step 2 are available
...
**Before we move on, any final thoughts about this technique? Any insights you want to make sure we carry forward?**
...
- **Load:** `./steps/step-04-idea-organization.md`
...
After technique completion and user confirmation, load `./steps/step-04-idea-organization.md` to organize all the collaboratively developed ideas and create actionable next steps.
